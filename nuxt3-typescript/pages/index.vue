<template>
  ...
  <div>
    <section>
      ...
      <section>
        <div
          class="max-w-lg px-4 sm:pt-24 pt-12 sm:pb-8 mx-auto text-left md:max-w-none md:text-center"
        >
          <div class="text-center py-4 hidden sm:block">
            ...
            >
              ...
              &nbsp; &nbsp;
              <span>{{ $t("page.index.twitter") }}</span>
            </button>
          </div>
          ...
          >
            <span class="inline md:block">{{ $t("page.index.building") }}</span>
            <span
              class="relative mt-2 bg-clip-text text-[#201515] md:inline-block"
            >
              {{ $t("page.index.software") }}
            </span>
          </h1>
        </div>

        <div
          class="max-w-lg px-4 pb-24 mx-auto text-left md:max-w-none md:text-center"
        >
    ...
    <div class="text-left">
      <div class="sm:px-28">
        <section class="relative flex items-center w-full">
          <div
            class="relative items-center w-full px-5 mx-auto md:px-12 lg:px-16 max-w-7xl"
          >
              ...
              <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-24">
                ...
                >
                  <div class="max-w-xl text-center lg:text-left">
                    <div>
                      <p
                        class="text-3xl font-semibold tracking-tight text-[#201515] sm:text-5xl"
                      >
                        {{ $t("page.index.title2") }}
                      </p>
                      <p
                        class="max-w-xl mt-4 text-base tracking-tight text-gray-600"
                      >
                        {{ $t("page.index.content") }}
                      </p>
                    </div>
                    <div
                      class="flex justify-center gap-3 mt-10 lg:justify-start"
                    >
                      <NuxtLink :to="localePath('/about')">
                        ...
                        >
                          <span>{{ $t("page.index.readMore") }} &nbsp; →</span>
                        </div>
                      </NuxtLink>
                    </div>
                  </div>
